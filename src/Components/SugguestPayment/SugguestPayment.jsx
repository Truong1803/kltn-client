...
import SuggestPaymentModal from "./SugguestPaymentDetail";
        ...
        return (
          <>
            ...
            {permission.map((itemPermission) => {
              if (itemPermission.permission === "OFFER REWARD") {
                return (
                  <Button
                    variant='outlined'
                    onClick={() => handleAction("OFFER", params.row)}
                    color='primary'
                    sx={{
                      backgroundColor: "#fff",
                      borderRadius: 0,
  ...
  return (
    <Box>
      ...
      >
        ...
        >
          Danh sách bài nghiên cứu đã duyệt
        </Typography>
      </Stack>
